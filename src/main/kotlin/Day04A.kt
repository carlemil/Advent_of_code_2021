...
class Day04A {
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            Day04A().solve4A(numbers, boards, markBoards)
        }
    }

    private fun solve4A(numbers: List<Int>, boards: List<List<List<Int>>>, mbs: MutableList<MutableList<MutableList<Int>>>) {
        numbers.forEach { n ->
    ...
    private fun markInBoard(n: Int, b: List<List<Int>>, mb: MutableList<MutableList<Int>>) {
        for (i in 0..4) {
            for (j in 0..4) {
                if (b[i][j] == n) {
                    mb[i][j] = 1
    ...
    private fun printScore(b: List<List<Int>>, mb: MutableList<MutableList<Int>>, n: Int) {
        var score = 0
    ...
    private fun checkWinningCondition(mb: MutableList<MutableList<Int>>, i: Int, j: Int): Boolean {
